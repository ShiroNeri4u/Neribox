...
for object in AOD DASHBOARD STATUSBAR ALIST_DAEMON ALIST_HTTPS ARIA2_DAEMON ARIA2_HTTPS ARIANG_WEBUI RCLONE_DAEMON MOUNTDIR CLOUDDIR FRPC_DAEMON FRPC_PARM TERMUX_REPO TRACKERLIST ROOT_MANAGER;do
...
#AList启动端口，左边为http,右边为https，-1为禁用，端口可为1-66535之间
